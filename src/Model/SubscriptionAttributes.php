...
class SubscriptionAttributes
{
    ...
    public function __construct($subscriptionName = null, $endpoint = null, $strategy = null, $contentFormat = null, $topicName = null, $topicOwner = null, $createTime = null, $lastModifyTime = null)
    {
    ...
    static public function fromXML(\XMLReader $xmlReader)
    {
        ...
        $attributes = new SubscriptionAttributes($subscriptionName, $endpoint, $strategy, $contentFormat, $topicName, $topicOwner, $createTime, $lastModifyTime);
